...
export default function Navbar({ isDark, onThemeToggle }: NavbarProps) {
  ...
  return (
    <motion.nav
      className="backdrop-blur-lg bg-white/80 dark:bg-slate-900/80 border-b border-gray-200/50 dark:border-slate-700/50 rounded-[28px]"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="px-4 lg:px-8 py-2.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            {/* AI Status Badge */}
            <div className="hidden lg:flex items-center gap-2 px-2.5 py-1 bg-cyan-100 dark:bg-cyan-900/30 rounded-full">
            ...
            {/* Notifications */}
            <button className="relative p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-2xl transition-colors">
